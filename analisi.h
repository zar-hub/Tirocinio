...
// Wed Oct  4 14:23:36 2023 by ROOT version 6.26/10
// from TTree T1/vecbos analysis tree for Z studies
// found on file: 4Nicola.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("4Nicola.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("4Nicola.root");
      }
      f->GetObject("T1",tree);
